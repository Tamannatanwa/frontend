    ...
    >
      <div className="pb-5">
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2">
          <img src={assets.search_icon} alt="search" className="max-h-5 mt-5" />
          <input
            type="text"
      ...
      <div className="flex flex-col">
        {userDummyData.map((user,index) => (
          <div key={user._id} className="flex items-center gap-3 p-2 rounded-lg relative cursor-pointer hover:bg-[#282142]" onClick={() => setSelectedUser(user)}>
           ...
           <div className="flex flex-col leading-5">
            ...
            {
                index>2 && <p className="absolute top-4 right-4 text-xs h-5 w-5 flex justify-center items-center required-full bg-violet-500/50">
                    {index}
                </p>
            }
          </div>
